...
Interval endpoints are noisy at small replicate counts and settle as the count increases; the tails (and thus 95% endpoints) need more replicates than the center to stabilize. Doubling the replicates and watching the endpoints converge is a practical way to judge "enough".
:::
