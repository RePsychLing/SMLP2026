...
- explain what the parametric bootstrap does and why it can give more accurate intervals than standard-error or profile methods;
...
**Datasets used:** `sleepstudy` and `kb07` (see the [dataset catalog](../getting-started/datasets.qmd)).
:::
...
- [Bootstrapping a Fitted Model](kb07.qmd) — a practical worked example applying parametric bootstrap to the Kronmueller & Barr (2007) dataset.
