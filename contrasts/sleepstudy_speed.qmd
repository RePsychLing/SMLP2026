...
**Datasets used:** the full Belenky `sleepstudy` data with all time-in-bed groups (see the [dataset catalog](../getting-started/datasets.qmd)).
:::
...
shrinkageplot!(Figure(; size=(500, 500)), m2)
```
