...
- read a longitudinal, repeated-measures dataset into a `DataFrame` and plot per-subject trends;
...
#| eval: false
df = DataFrame(dataset(:sleepstudy))
m_int   = fit(MixedModel, @formula(reaction ~ 1 + days + (1 | subj)), df)
m_slope = fit(MixedModel, @formula(reaction ~ 1 + days + (1 + days | subj)), df)
