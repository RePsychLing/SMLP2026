...
<!-- TODO: add a section on the different methods to the bootstrap file and a xref here -->
Later we discuss other available methods for computing confidence intervals.
:::
