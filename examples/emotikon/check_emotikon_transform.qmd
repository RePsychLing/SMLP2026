...
1. **Does the conclusion hold?** State, in one sentence, whether the age-by-sex-by-test interaction is significant when the two timed tasks are analysed in their original (time) metric rather than transformed to speed. What does that imply about the robustness of the published conclusion?
